                ...
                <div class="card position-relative border-0">
                  ...
                  <div class="card-footer p-0 border-top border-translucent">
                    <form action="{{ route('admin.logout') }}" method="post">
                        @csrf
                        <div class="px-3"> <button type="submit" class="btn btn-phoenix-secondary d-flex flex-center w-100" href="#!"> <span class="me-2" data-feather="log-out"> </span>Sign out</button></div>
                    </form>
